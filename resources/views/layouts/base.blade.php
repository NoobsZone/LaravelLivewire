...
<head>
    @if(env('IS_DEMO')) 
        ...
        <meta  name="keywords" content="themesberg, updivision, html dashboard, laravel, livewire, laravel livewire, alpine.js, html css dashboard laravel, LivewireAdmin Dashboard, livewire volt dashboard, volt admin, livewire dashboard, livewire admin, web dashboard, bootstrap 5 dashboard laravel, bootstrap 5, css3 dashboard, bootstrap 5 admin laravel, volt dashboard bootstrap 5 laravel, frontend, responsive bootstrap 5 dashboard, volt dashboard, Livewirebootstrap 5 dashboard"></meta>
        <meta  name="description" content="LivewireAdmin Dashboard features dozens of UI components and a Laravel backend with Livewire & Alpine.js"></meta>
        <meta  itemprop="name" content="LivewireAdmin Dashboard by Themesberg & UPDIVISION"></meta>
        <meta  itemprop="description" content="LivewireAdmin Dashboard features dozens of UI components and a Laravel backend with Livewire & Alpine.js"></meta>
        ...
        <meta  name="twitter:title" content="LivewireAdmin Dashboard by Themesberg & UPDIVISION"></meta>
        <meta  name="twitter:description" content="LivewireAdmin Dashboard features dozens of UI components and a Laravel backend with Livewire & Alpine.js"></meta>
        ...
        <meta  property="og:title" content="LivewireAdmin Dashboard by Themesberg & UPDIVISION"></meta>
        ...
        <meta  property="og:description" content="LivewireAdmin Dashboard features dozens of UI components and a Laravel backend with Livewire & Alpine.js"></meta>
