...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        ...
        <div>
            <a class="nav-item {{ Request::segment(1) == 'bootstrap-tables' ? 'active' : '' }} btn btn-outline-gray-600 d-inline-flex align-items-center" href="/forms" >
            ...
            <table class="table table-centered table-nowrap mb-0 rounded">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th class="border-0">Marital Status</th>
